...
public class SimpleHttpServer {
        ...
        try {
            ...
            while (isEnable){
                ...
                threadPool.submit(new Runnable() {
                    @Override
                    public void run() {
                        Log.i("iplay","a remote peer accept..." + remotePeer.getRemoteSocketAddress().toString());
                        onAcceptRemotePeer(remotePeer);
                    }
                });
            }
        } catch (IOException e) {
            Log.e("iplay",e.toString());
        }
    }
    ...
    private void onAcceptRemotePeer(Socket remotePeer) {
        try {
            ...
            Log.i("iplay","resourceUri====>"+resourceUri);
